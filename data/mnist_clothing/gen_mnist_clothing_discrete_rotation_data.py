...
dest_path = os.path.join('..', '..', 'dataset_lists', 'mnist_clothing_lists')
...
for file in source_text_lists:
    ...
    if file.startswith('test'):
        with open(os.path.join(source_text_path, file), 'r') as f:
            ...
            file_out = file.replace('rotation', 'clothing')
        with open(os.path.join(dest_path, file_out), 'w') as f_out:
            ...
            for outgoing_file in outgoing_files:
                f_out.write('mnist_clothing/self_generated/unseen_images/' + outgoing_file + '\n')
    ...
    if file.startswith('train'):
        ...
        for key in unique_png_filename_train:
            ...
            train_files = ['mnist_clothing/self_generated/' + key + '/' + x for x in train_files]
            val_files = ['mnist_clothing/self_generated/' + key + '/' + x for x in val_files]
        ...
        val_file_out = val_file.replace('rotation', 'clothing')
